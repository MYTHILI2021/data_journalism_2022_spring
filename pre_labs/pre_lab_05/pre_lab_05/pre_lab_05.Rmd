...
**Answer** The city names are not cleaned and with different spellings and cases, R is unable to sort and group them by the names.
...
**Answer** refinr changed some city names from all upper case to capital case, like PHOENIX to Phoenix and WESTMINISTER to Westminister, some cities were unchanged like EASTON.
...
**Answer** refinr changed ABELL to Abell, aberdeen to Aberdeen,ADELPHI to Adelphi.
...
**Answer** No, the changes are similarly made.
