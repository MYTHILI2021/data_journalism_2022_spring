...
**Answer** The dataframe covid_tweets has the content of the tweets, the user IDs that posted these tweets, their political roles, and the parties they belong to. 
...
**Answer** The function is case sensitive and removes repetition according to that. Even punctuation is treated as a character here. 
...
**Answer** Using unnest_tokens, we have a dataframe with each unique word as an entry. There are 5369025 unique words in the content column of covid_tweets.
...
**Answer**  The resulting graph shows which words are used the most. "covid" is used about 75000 times and "covid19" and "coronavirus" around 50000 times in these tweets.All three variations of the word make it into top 25 of most used words.
...
**Answer** The new list has much more relevant words with the removal of general words like "the" and "a". With the percentages, we can see that "covid","19","covid19" and "coronavirus" make the top 5 most used words in the list. With the new list, we can easily compare words like "covid" with "pandemic" or "vaccine" to get a more coherent pattern in the tweets.
...
**Answer** From the results we can see that "covid" was tweeted more in 2020 than 2021.The words also point to trends such as "pandemic" and "crisis" were mentioned more in 2020 and "vaccines" were mentioned more in 2021.
...
**Task** Run the following code and describe the results.
**Answer** The results show a more detailed result than previously with words like "health care","public health", "relief package", "covid relief" instead of just health or relief. This extra layer helps with context of the word and its narrative.
...
**Task** Run the following code and describe the results.
**Answer** The results still have covid-19 and its variations mentioned the most but "vaccine" and "pandemic" are trending pretty high too. Health care has slipped lower.  
...
**Task** Run the following code and describe the results.
**Answer** The Democrats mentioned words like "public health", "health care" and "social distancing" more while the Republicans had words like "cares act" and "american people" in their tweets that stood out. The analysis gives us a better understanding of what party is trying to advocate for what on Twitter.
...
**Task** Run the following code and describe the results.
**Answer** "president trump" was a trending topic in 2020 for House candidates, giving "covid19" some competition. However, in 2021, the House candidates tweeted about "vaccine mandates" and the "Biden administration".
...
**Answer** Words like "Kill" and "killing" have negative sentiments in the data but when talking in the context of covid, "killing germs" or "killing the virus/infection" can be a positive sentiment.
