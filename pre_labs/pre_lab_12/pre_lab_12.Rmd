...
**Answer** The dataframe shows the numbers of vaccinations completed in different counties by date.
...
**Answer** After counting the total vaccinations per county, we can note that one of the entries in the county column with 284 vaccinations is 'NA'. And all the other counties have similar number of totals.
...
**Answer**  This data represents all the vaccinations which had their county as NA.
...
**Answer** The pattern for the recent 7-10 days shows that the rank is increasing by 10 places approximately as the number of fully_vaccinated people reduce.
...
**Answer** The number of fully vaccinated people has gone down since it peaked in April 2021. 
...
**Answer** "The number of people in Prince George's County who got fully vaccinated on March 06 decreased by -73.77 percent compared to the week before"
...
**Answer** Some counties have significantly higher covid cases than others but the chart doesn't include the population versus covid cases data which makes it harder to tell which county had more cases.
...
**Task** Run the following code and describe what the resulting chart shows
**Answer** The chart shows a consolidated version of the previous chart and shows a bigger picture.
...
**Answer** 3233 rows in the counties dataframe.
...
**Answer** 24 rows in the mdcounties dataframe.
...
**Answer** The map shows Covid-19 cases of a particular day which is April 18, 2022. The map also highlights the counties with higher numbers in yellow. 
