...
**Answer** https://datawrapper.dwcdn.net/yIBkk/1/
...
**Answer** The code is grouping the maryland_ppp data by county names and summarizing them by count.
...
**Answer**  The code below is filtering out counties with a count less than 6 so only counties greater than 6 are displayed.
...
**Answer** FIPS codes columns have five-digit codes, combining the state and county codes.
...
**Answer** The dataframe has both the counties and their respective FIPS code joined in one.
...
**Answer** The map is zoomed into Maryland, highlighting counties with different colors.
...
**Answer** On hovering over each county, the county names are displayed and the numbers have commas after the customization.
...
**Answer** https://datawrapper.dwcdn.net/OnO7n/1/
