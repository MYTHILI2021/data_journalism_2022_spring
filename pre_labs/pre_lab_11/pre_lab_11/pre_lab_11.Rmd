...
**Answer** The collection of files include are part of the Hospitals shapefile.
...
**Answer** There are multiple columns in this data resembling a data frame except there's an extra column called the "Geometry" column.
...
**Answer** We got 72 Maryland Hospitals' data and the first 10 entries are shown in the output.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** There are 7 different types of hospitals which are GENERAL ACUTE CARE, PSYCHIATRIC, MILITARY, CHRONIC DISEASE, LONG TERM CARE, REHABILITATION, SPECIAL.	
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The output showed the first 10 of 50 entries that are Maryland General Acute Care Hospitals.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** THe output is a scatter plot of the 50 hospitals in Maryland. It's plotted by using the ggplot and the latitude and longitude values from the shapefile. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The package is installed and run.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The function retrieves all the county data for the year 2020.
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Here, we have filtered all the Maryland county data for the year 2020 using the FIPS code "24".
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The output shows a county level map of Maryland but no data.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The output shows a Maryland county map with the hospital data layered over it. The map shows where the hospitals are located.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The output is the previous map but with an added color palette with the number of beds in each hospital included via the colors.
...
**Answer** The libraries are loaded and run.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The output results in a shapefile of Maryland hospitals, filtered by General Acute Care.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The output shows the number of beds per county in Maryland.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Here, we're adding a grabbing the population at a county level using the Census API.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Since the previous dataframe didn't have the geometry information, we're grabbing that from the Census API as well.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** We're grabbing the two dataframes of populations and beds by county. The county names are differently noted. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** We're renaming the county name structures to make the join possible between the two dataframes from above.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Here, we joined the county population dataframe with the beds by county dataframe and created a new dataset.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The columns with NA in the total_bed column has changed to 0.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** We're standardizing the bed count to the county population by multiplying it with 100,000. This will allow us to get a highest to lowest ranking in the hospital bed in the counties.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** We've visualized the data we got from above into a map.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** We've changed the color scale since the previous color scale didn't help in figuring the smaller details.
...
**Answer** Using the "log" scale, the map now shows some of the finer details.
