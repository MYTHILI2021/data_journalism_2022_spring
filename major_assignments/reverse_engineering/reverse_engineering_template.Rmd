...
* **Analysis summary**: I calculated the donations to the two main political parties and the amount exceeded $3.4 million -- the total amount is $4,646,369 without even counting what the large fundraising vehicles brought in. 
...
major_donations<- nc_finance_data %>% filter(
            committee_name == 'NC DEC - STATE' |
            committee_name == 'NC REC - STATE'
) 
