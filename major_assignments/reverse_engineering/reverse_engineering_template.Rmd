...
This data comes from campaign finance data. The main sections we focused on were name-clean (Name of donor), committee-name (who the money was for), amount (how much the donation was for). We had to do some mild cleaning of the data with the names and then changed the format of the date to be better served.
