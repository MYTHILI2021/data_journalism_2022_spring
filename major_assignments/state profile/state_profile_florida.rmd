...
**A1.** There are 98,3362 applications in Florida for PPP, according to the dataset.
Miami-Dade county got the highest number of loans with 2,22,558. 22 loans were recorded with NA as their county name. 
Miami-Dade also had the highest number of jobs retained with 10,94,393. About 11 counties got the max loan amount of 1,00,00,000.
...
**A2.** Florida has 4704 loans per 100,000 people. Monroe county has the highest number of loans per capita for a population of 75798.
...
**A4.** The taxi service industry came in second in top 10 industries which applied for PPP loans in Florida state.
