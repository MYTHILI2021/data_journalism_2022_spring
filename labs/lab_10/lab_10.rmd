...
**A2.** The new chart, a scatter plot, shows a new metric for ranking the states. By calculating the percentage of undisbursed amounts to their total applications, we get a new result. Louisiana has the most undisbursed amounts when compared to its total applications received.
