...
**A4** Palm Beach County does not exist in West Virginia.And Kanawha County is West Virginia's most populous county.
...
**A5** Greenbriar Hotel Corporation got a loan amount of 8912202. It's a luxury resort/hotel. They retained 500 jobs according to the data.
...
**A6** West Virginia's governor, Jim Justice owns Greenbriar Hotel Corporation.Forbes listed it under his profile on their page.
...
**A7** More than 30,000 loans have been granted in West Virginia, 33,336 to be exact. Amounting to a total of 2.6 billion dollars worth of loans granted, many applied for a loan of median amount $20,832 as $20,833 is the maximum possible PPP loan given for sole proprietors or independent contractors.
```{r}
# Write the code to produce your answer here'
