...
**A2** It's easier to quantify the data using percentages which we did by adding a column.
...
**A3** Calvert: -76.92
       Southern Maryland Region: -58.461538
...
**A4** In 2017 and 2018, it was former President Trump's era. Trump was strongly against international immigrants. Trump signed an executive order around 2018 on limiting immigrants and refugees.And Maryland is home for the largest number of immigrants from countries like El Salvador, India, China, etc.
...
```{r}
# Write the code to produce your answer here
 domestic_migration %>% arrange(total)
...
**A7** The number's are slightly difficult to understand the big picture of domestic migrants. Forms like percentages give a more clearer understanding in comparing one region to another.
Counties like Carroll and Harford stand out as they had such a drastic difference in migrant numbers in 2017, 2018, 2019, compared to previous years. It makes us question whether there were any new policies or migration groups that entered these counties.
